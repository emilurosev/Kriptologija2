...
/**
 * <p>
 * This class is responsible for receiving input from a unique user on the end
 * of a socket connection. The user commands will be validated and
 * performed.</p>
 *
 * @author sjunejo
 */
public class TelnetClient extends Thread {
     ...
     * <li> Basically the BufferedReader class methods are synchronized and
     * blocking IO operations.
     * <li> To overcome this inherent Blocking feature while the execution of
     * thread , we need to explicitly close the socket which are in use, to
     * throw an SocketException to accomplish the Exit of Thread.run()
     */
    ...
    /**
     * This method will parse the user input and return the new working
     * directory
     *
